# HANDOVER-archive.md — Archivierte Schichtübergaben

> Ältere Einträge aus `HANDOVER.md`, ausgelagert um die laufende Schichtübergabe lesbar zu halten. Reihenfolge wie im Original: neueste zuerst.
> Wenn `HANDOVER.md` wieder über ~20 Einträge wächst, den ältesten Block ans Ende dieser Datei verschieben.
